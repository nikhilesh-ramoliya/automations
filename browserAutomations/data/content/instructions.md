...
Themes every topic and post should clearly relate to. Usage is tracked so runs rotate across these.
...
- No clickbait or hype openers
- No filler: `"in today's fast-paced world"`, `"game-changer"`, `"unlock the power"`, `"synergy"`
- No hard-sell: `"book a call"`, `"book a demo"`, `"DM me for pricing"`, `"limited time"`, `"click the link"`
